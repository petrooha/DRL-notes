...
def create_tiling_grid(low, high, bins=(10, 10), offsets=(0.0, 0.0)):
    ...
    array0 = []
    array1 = []
    grid0 = (high[0] - low[0]) / bins[0]
    grid1 = (high[1] - low[1]) / bins[1]
    for i in range(1, bins[0]):
        array0.append(low[0] + grid0*i + offsets[0])
    for i in range(1, bins[1]):
        array1.append(low[1] + grid1*i + offsets[1])
...
print("\nTilings:", repr(tilings), sep="\n")

print(samples[1], tilings[1])
enc = np.digitize(samples[1][0], tilings[1][0])
print(samples[1][0])
print(tilings[1][0])
...
class QTable:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.q_table = np.zeros(shape=(state_size[0], state_size[1], action_size))
